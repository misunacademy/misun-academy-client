                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex gap-3">
                            ...
                            <div className="flex-1 relative p-[1.5px] rounded-xl overflow-hidden">
                                ...
                                <button onClick={onClose}
                                    className="relative w-full bg-gradient-to-r from-emerald-darker via-primary to-emerald-dark hover:from-emerald-deep hover:via-emerald-bright hover:to-emerald-deep transition-all duration-300 text-white font-bold py-2.5 rounded-xl text-sm">
                                    লগইন করুন
                                </button>
                            </div>
                        </div>
