...
const faqs = [
    {
        ...
        answer: "কোর্সে ভর্তি হতে শুধু একটি ল্যাপটপ/কম্পিউটার এবং ইন্টারনেট সংযোগ লাগবে। পেমেন্ট সম্পন্ন হলে আপনি ইমেইলে ভর্তির তথ্য পাবেন। ডিজাইনের কোনো পূর্ব অভিজ্ঞতা ছাড়াও সম্পূর্ণ শূন্য থেকে শুরু করা যাবে।",
    },
    {
        question: "গ্রাফিক্স ডিজাইন শিখতে কোনো ডিভাইস লাগবে?",
        answer: "কোর্সটি করতে একটি মিনিমাম কনফিগারেশনের PC বা Laptop থাকলে ভালো হয়। Adobe Illustrator ও Photoshop — এই সফটওয়্যারগুলো ব্যবহারের গাইডও কোর্সে অন্তর্ভুক্ত।",
    },
    {
        question: "কোর্স শেষ করলে কি সত্যিই ইনকাম করা যাবে?",
        answer: "হ্যাঁ, অবশ্যই। আমাদের ৪ মাস পূর্ণভাবে লেগে থাকা স্টুডেন্টরা Job, Local Client এবং International Market Place এ কাজ পাচ্ছেন। কোর্সে ক্লায়েন্ট ডিলিং, প্রাইসিং, পোর্টফোলিও বিল্ডিং — সব কিছুই হাতে-কলমে শেখানো হয়।",
    },
    {
