...
const profileSchema = z.object({
  ...
  currentJob: z.string().optional(),      // Designation / Job Title
  industry: z.string().optional(),        // Department
  experience: z.enum(["0-1", "1-3", "3-5", "5-10", "10+"]).optional(),
  // Keep minimal optional fields
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="bio"
                    {...register('bio')}
                    placeholder="A short bio about yourself, your role, and expertise..."
