...
import { Plus, Book, Video, FileText, ChevronDown, ChevronRight, Edit, Trash2, GripVertical, ArrowUp, ArrowDown } from "lucide-react";
...
function ModuleFormDialog({ open, mode, data, courseId, batchId, batches, onBatchChange, onClose, onSuccess }: {
  open: boolean;
  mode: 'create' | 'edit';
  data?: Module;
  courseId: string;
