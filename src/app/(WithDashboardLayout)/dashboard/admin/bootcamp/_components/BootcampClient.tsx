...
import BootcampStatsCards from "./BootcampStatsCards";
import BootcampCatalogManager from "./BootcampCatalogManager";
import { bootcampColumns } from "./bootcampColumns";
import BootcampReviewDialog from "./BootcampReviewDialog";
