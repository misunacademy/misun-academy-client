...
const RecordingForm = ({ defaultValues, courses, onSubmit, isLoading }: RecordingFormProps) => {
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <Select onValueChange={(value) => { field.onChange(value); form.setValue("batchId", ""); }} value={field.value}>
                  <FormControl>
                    <SelectTrigger>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input {...field} placeholder="e.g., Week 1: Introduction to the course" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
